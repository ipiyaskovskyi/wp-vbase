<footer class="footer" role="contentinfo">
    <div class="l-container">
        <div class="row">
            <section class="l-section l-section-sm col-lg-6 col-md-12 col-sm-12 sm:u-items-center sm:u-text-center" aria-labelledby="social-links-heading">
            <div class="footer-newsletter">
                <h2 id="products-heading" class="footer-title"><?php esc_html_e('Sign up to our mailing list', 'vbase'); ?></h2>
                <?php
                // Check if Contact Form 7 is active
                if (function_exists('wpcf7')) {
                    // Try to get form by title or ID
                    $form_id = get_option('vbase_newsletter_form_id', '');
                    if ($form_id) {
                ...
                <nav class="footer-top-left-social" aria-label="<?php esc_attr_e('Social Media Links', 'vbase'); ?>">
            ...
            <section class="l-section l-section-sm col-lg-4 col-md-12 col-sm-12 sm:u-items-center sm:u-text-center" aria-labelledby="products-heading">
                <h2 id="products-heading" class="footer-title"><?php esc_html_e('Products', 'vbase'); ?></h2>
                <nav class="footer-menu" aria-label="<?php esc_attr_e('Products Menu', 'vbase'); ?>">
            ...
            <section class="l-section l-section-sm col-lg-2 col-md-12 col-sm-12 sm:u-items-center sm:u-text-center" aria-labelledby="pages-heading">
                <h2 id="pages-heading" class="footer-title"><?php esc_html_e('Pages', 'vbase'); ?></h2>
                <nav class="footer-menu" aria-label="<?php esc_attr_e('Pages Menu', 'vbase'); ?>">
                    <ul>
                    <?php
                    wp_nav_menu([
        ...
        <section class="l-section l-section-lg l-section-border-top l-section-border-top-lg u-flex u-justify-between u-items-center u-flex-wrap u-gap-2xl md:u-gap-lg" aria-labelledby="footer-legal-heading">
            ...
            <nav class="footer-terms" aria-label="<?php esc_attr_e('Legal Links', 'vbase'); ?>">
                <ul>
                    <li>
        ...
        <section class="l-section l-section-md l-section-border-top l-section-border-top-md">
            <div class="footer-copyright">
                <small>&copy; <?php echo esc_html(date('Y')); ?> validityBase. <?php esc_html_e('All rights reserved.', 'vbase'); ?></small>
            </div>
        </section>
    </div>
</footer>
