...
<main id="main-content" class="site-main blog-page">
    <div class="l-container">
        ...
        <nav class="blog-breadcrumb" aria-label="<?php esc_attr_e('Breadcrumb', 'vbase'); ?>">
            <a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Home', 'vbase'); ?></a>
            <span class="breadcrumb-separator"><?php esc_html_e('>', 'vbase'); ?></span>
        ...
        ?>
            ...
            ?>
                ...
                if ($grid_posts->max_num_pages > 1) {
                    // Get blog page URL (if static page is set as posts page)
                    $blog_page_id = get_option('page_for_posts');
                    if ($blog_page_id && get_option('show_on_front') === 'page') {
                        $blog_url = get_permalink($blog_page_id);
                        $base = trailingslashit($blog_url) . 'page/%#%/';
                        $format = 'page/%#%/';
                    } else {
                        // For default blog (home page)
